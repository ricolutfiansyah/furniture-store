...
type Order struct {
	...
	PaidAt          NullTime  `db:"paid_at" json:"paid_at,omitzero"`
	ShippedAt       NullTime  `db:"shipped_at" json:"shipped_at,omitzero"`
	DeliveredAt     NullTime  `db:"delivered_at" json:"delivered_at,omitzero"`
