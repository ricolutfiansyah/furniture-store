...
type Category struct {
	...
	Description nullable.NullString `db:"description" json:"description"`
	ParentID    *int                `db:"parent_id" json:"parent_id,omitempty"`
	ImageURL    nullable.NullString `db:"image_url" json:"image_url"`
...
type Product struct {
	...
	SKU         nullable.NullString `db:"sku" json:"sku"`
